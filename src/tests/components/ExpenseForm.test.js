...
// Render ExpenseForm with the data
...
// We are going to write a test case that makes sure an error gets rendered when the form is submitted without a description or without an amount
